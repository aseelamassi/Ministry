...
import com.sh.wm.ministry.databinding.LoadStateItemBinding;

import org.jetbrains.annotations.NotNull;

public class InspectionLoadState extends androidx.paging.LoadStateAdapter<InspectionLoadState.LoadStateViewHolder> {
    // Define Retry Callback
    private View.OnClickListener mRetryCallback;

    public InspectionLoadState(View.OnClickListener retryCallback) {
        // Init Retry Callback
