...
public class UserWorkInfo {
    ...
    @SerializedName("USER_DIRECTORATE_ID")
    @Expose
    private String uSERDIRECTORATEID;
    ...
    public String getUSERDIRECTORATEID() {
        return uSERDIRECTORATEID;
    }

    public void setUSERDIRECTORATEID(String uSERDIRECTORATEID) {
        this.uSERDIRECTORATEID = uSERDIRECTORATEID;
    }
