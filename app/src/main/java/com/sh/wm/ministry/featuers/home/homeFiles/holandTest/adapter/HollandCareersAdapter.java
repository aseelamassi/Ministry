...
public class HollandCareersAdapter extends RecyclerView.Adapter<HollandCareersAdapter.MyViewHolder> {


    private Context context;
    private HollandCareersModel careersModel;
    HashMap<String , String > questions ;

    public HollandCareersAdapter(Context context, HollandCareersModel careersModel) {
        questions = new HashMap<>();
        this.context = context;
        this.careersModel = careersModel;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        switch (position){
            case 0:
                ...
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs1()));
                break;

            case 1:
                holder.binding.tvTitle.setText(R.string.investigative);
                holder.binding.rvQuestions.setLayoutManager(new LinearLayoutManager(context));
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs2()));
                break;
            case 2:
                holder.binding.tvTitle.setText(R.string.artistic);
                holder.binding.rvQuestions.setLayoutManager(new LinearLayoutManager(context));
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs3()));
                break;
            case 3:
                holder.binding.tvTitle.setText(R.string.social);
                holder.binding.rvQuestions.setLayoutManager(new LinearLayoutManager(context));
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs4()));
                break;
            case 4:
                holder.binding.tvTitle.setText(R.string.enterprising);
                holder.binding.rvQuestions.setLayoutManager(new LinearLayoutManager(context));
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs5()));
                break;
            case 5:
                holder.binding.tvTitle.setText(R.string.conventional);
                holder.binding.rvQuestions.setLayoutManager(new LinearLayoutManager(context));
                holder.binding.rvQuestions.setAdapter(new ActivityAdapter(context, careersModel.getJobs6()));
                break;
        }
    ...
    public HollandCareersModel getCareers() {
        return careersModel;
    }
}
