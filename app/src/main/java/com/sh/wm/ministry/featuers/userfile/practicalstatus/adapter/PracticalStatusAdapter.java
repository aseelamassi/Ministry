...
public class PracticalStatusAdapter extends RecyclerView.Adapter<PracticalStatusAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private  TextView tvDescribeDescribePracticalStatus;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tvDescribeDescribePracticalStatus = itemView.findViewById(R.id.tv_describe_describe_practical_status);
        ...
        public void bind(int position) {
            ...
            tvDescribeDescribePracticalStatus.setText(workStatus.getWORKSTATUSDESCDESC());
...
//            });
    ...
    public interface OnEditClickListener {
        ...
        void onClick(UserWorkStatus workStatus);
    }
}
