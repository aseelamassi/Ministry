...
public class SharedPreferneceHelper {
    ...
    public static boolean isAutoStart(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("autoStart", Context.MODE_PRIVATE);
    ...
    public static String getTestId(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(ApiConstent.TEST_ID, Context.MODE_PRIVATE);
        return preferences.getString(ApiConstent.TEST_ID, "Empty");
