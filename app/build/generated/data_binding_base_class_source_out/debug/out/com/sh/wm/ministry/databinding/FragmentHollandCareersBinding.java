...
public final class FragmentHollandCareersBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHollandCareersBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RecyclerView rvCareers, @NonNull TextView tvLabel, @NonNull TextView tvNoInternet) {
  ...
  @NonNull
  public static FragmentHollandCareersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHollandCareersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_holland_careers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHollandCareersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHollandCareersBinding((RelativeLayout) rootView, btnNext, btnPrev, btnSave,
          progress, rlButtonsContainer, rvCareers, tvLabel, tvNoInternet);
    }
